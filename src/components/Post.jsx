...
export default function Post() {
  ...
  const handleclick = (e) => {
    e.preventDefault();
    const postdata1=inputRef.current.value;
    ...
    if (postdata) {
      ...
      postobj.creator = getFromLocalStorage("currentUser");
                      ...
                      <div class="_feed_inner_public_story _b_radious6">
                        <div class="_feed_inner_public_story_image">
                          <img
                            ...
                            alt="Image"
                            class="_public_story_img"
                          />
                          <div class="_feed_inner_pulic_story_txt">
                            <p class="_feed_inner_pulic_story_para">
                              Ryan Roslansky
                            </p>
                          </div>
                        ...
                        <a href="#0" class="_feed_inner_ppl_card_area_link">
                          <div class="_feed_inner_ppl_card_area_story">
                            <img
                              ...
                              alt="Image"
                              class="_card_story_img"
                            />
                            <div class="_feed_inner_ppl_btn">
                              <button
                                class="_feed_inner_ppl_btn_link"
                                type="button"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                          ...
                          <p class="_feed_inner_ppl_card_area_link_txt">
                            Your Story
                          </p>
                        </a>
                      </li>
                  ...
                  <div class="_feed_inner_text_area_bottom">
                    <div class="_feed_inner_text_area_item">
                      <div class="_feed_inner_text_area_bottom_photo _feed_common">
                        <button
                          type="button"
                          class="_feed_inner_text_area_bottom_photo_link"
                        >
                          {" "}
