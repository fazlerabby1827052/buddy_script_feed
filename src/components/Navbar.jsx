          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="_header_form ms-auto">
              <form class="_header_form_grp">
                ...
                <input
                  class="form-control me-2 _inpt1"
                  type="search"
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              <li class="nav-item _header_nav_item">
                <a
                  class="nav-link _header_nav_link_active _header_nav_link"
                  aria-current="page"
                  href="feed.html"
                >
                  <svg
              ...
              <li class="nav-item _header_nav_item">
                <a
                  class="nav-link _header_nav_link"
                  aria-current="page"
              ...
              <li class="nav-item _header_nav_item">
                <span
                  id="_notify_btn"
                  class="nav-link _header_nav_link _header_notify_btn"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                  ...
                  <div id="_notify_drop" class="_notification_dropdown">
                    <div class="_notifications_content">
                      <h4 class="_notifications_content_title">
                        Notifications
                      </h4>
                      <div class="_notification_box_right">
                        <button
                          type="button"
                          class="_notification_box_right_link"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="4"
                    ...
                    <div class="_notifications_drop_box">
                      <div class="_notifications_drop_btn_grp">
                        <button class="_notifications_btn_link">All</button>
                        <button class="_notifications_btn_link1">Unread</button>
                      </div>
                        ...
                        <div class="_notification_box">
                          ...
                          <div class="_notification_txt">
                            <p class="_notification_para">
                              <span class="_notify_txt_link">Steve Jobs</span>
            ...
            <div class="_header_nav_profile_wrap _header_nav_light">
              <div class="_header_nav_mode_switch_wrap">
                <button class="_header_nav_mode_btn _header_nav_light_link">
                  <span class="_header_nav_light_link_ic1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="13"
                      height="18"
                  ...
                  <span class="_header_nav_light_link_ic2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
              ...
              <div class="_header_nav_profile">
                <div class="_header_nav_profile_image">
                  <img
                    ...
                    alt="Image"
                    class="_nav_profile_img"
                  />
                </div>
                <div class="_header_nav_dropdown">
                  <p class="_header_nav_para">
                    {currentuser ? currentuser : ""}
                  </p>
                  <button
                    id="_profile_drop_show_btn"
                    class="_header_nav_dropdown_btn _dropdown_toggle"
                    type="button"
                ...
                {/* <!-- dropdown --> */}
                <div id="_prfoile_drop" class={`_nav_profile_dropdown ${dropdowntoggle?'show':""}`}>
                  ...
                  <ul class="_nav_dropdown_list">
                    ...
                    <li class="_nav_dropdown_list_item">
                      <a href="" onClick={handleonclick} class="_nav_dropdown_link">
                        <div class="_nav_drop_info">
                          <span>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
